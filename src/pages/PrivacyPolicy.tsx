  ...
  return (
    <div className="min-h-screen bg-[#FFF] py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-bold text-[#133134] mb-8">Privacy Policy</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-[#133134] mt-8 mb-4">1. Information We Collect</h2>
          <p className="text-[#3E4238] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#133134] mt-8 mb-4">2. How We Use Your Information</h2>
          <p className="text-[#3E4238] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#133134] mt-8 mb-4">3. Data Security</h2>
          <p className="text-[#3E4238] mb-6">
