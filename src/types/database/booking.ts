...
// Type for database operations (matches Supabase expectations)
export interface BookingInsert extends Omit<BookingDB, 'id' | 'created_at'> {
  reservation_code?: string; // Optional for insert since it's generated by trigger
}
